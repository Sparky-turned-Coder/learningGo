...
func main() {
	...
	fmt.Printf("What pokemon are we checking on today? ")
	fmt.Scanln(&pokeName)
	...
	fmt.Printf("The base power of your %s's Hidden Power ability is: %.2f\n", pokeName, math.Floor(powerFormula(u, v, w, x, y, z)))
}
...
Result:
	Base Power - 51
	Type - Bug  (I looked this up online. Let's see if OUR type calculator comes up with the same.)

*/

/*
Steps we went through when figuring this pokemon calculator out:
